...
#  check derivative function by using lim
def check_grad(x):
	eps = 1e-4
	g = np.zero_like(x)
...
# Gradient descent function: x = x0 - alpha * f'(x)
...
# Draw parabol using x = ((A^T*A)^(-1)*A^T*b
